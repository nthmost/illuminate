...
class InteropQualityMetrics(InteropBinParser):
    ...
    # uncomment the following and fill with new defaults, if desired.
    # flowcell_layout = {}
    ...
    def get_qscore_percentage(self, target_qscore=30, read_num=-1):
        ...
        # Return a percentage (like in Illumina SAV)  (ASK: leave it as a decimal?) 
    ...
    def parse_binary(self):
        ...
        bs = self.bs   #convenience assignment while parser is being developed in standalone file.
    ...
    def __str__(self):
        out = "Entries in parsed data: %i" % len(self.data['cycle'].values)
        return out
